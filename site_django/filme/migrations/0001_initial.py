    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categoria', models.CharField(choices=[('ANALISE', 'Análise'), ('PROGRAMACAO', 'Programação'), ('APRESENTACAO', 'Apresentação'), ('OUTRO', 'Outro')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filme_vistos', models.ManyToManyField(to='filme.filme')),
